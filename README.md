...
I am currently at [Snowflake AI Research](https://www.snowflake.com/en/product/ai/ai-research/), where I lead the development of [Arctic Inference](https://github.com/snowflakedb/ArcticInference) and contributed to training [Arctic](https://huggingface.co/Snowflake/snowflake-arctic-instruct), a 480B sparse MoE LLM. My research interests lie broadly in efficient ML systems, algorithms, and architectures. Previously, I served as the CEO of [Petuum](https://www.cmu.edu/news/stories/archives/2017/october/petuum-funding.html) and received my PhD in Computer Science from Carnegie Mellon University, where I was supervised by [Eric Xing](https://www.cs.cmu.edu/~epxing/).
