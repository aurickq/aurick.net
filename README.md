...
I am currently at [Thinking Machines Lab](https://thinkingmachines.ai/). My interests lie broadly in efficient ML systems, algorithms, and architectures. Previously, I was at [Snowflake AI Research](https://www.snowflake.com/en/product/ai/ai-research/), where I led the development of [Arctic Inference](https://github.com/snowflakedb/ArcticInference) and contributed to training [Arctic](https://huggingface.co/Snowflake/snowflake-arctic-instruct), a 480B sparse MoE LLM. Before that, I served as the CEO of [Petuum](https://www.cmu.edu/news/stories/archives/2017/october/petuum-funding.html) and received my PhD in Computer Science from Carnegie Mellon University, where I was supervised by [Eric Xing](https://www.cs.cmu.edu/~epxing/).
